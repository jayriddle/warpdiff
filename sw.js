...
const ASSETS = ['./', 'index.html', 'js/audio-viz.js', 'js/scopes.js', 'js/hotkeys.js', 'js/mp4-demux.js', 'js/starfield.js', 'favicon-32.png', 'icon-192.png', 'icon-512.png', 'manifest.json'];
