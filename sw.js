...
const CACHE_NAME = 'warpdiff-v3.14.10';
const ASSETS = ['./', 'index.html', 'js/audio-viz.js', 'js/scopes.js', 'js/hotkeys.js',
  'js/managed-review.js', 'js/mp4-demux.js', 'js/scrub-video.js', 'js/timecode.js', 'js/wipe.js', 'js/tile-check.js', 'js/audio-routing.js', 'js/opus-sync.js', 'js/audio-decode.js', 'js/transport.js', 'js/starfield.js', 'version.json', 'favicon-32.png', 'icon-192.png', 'icon-512.png', 'manifest.json'];
