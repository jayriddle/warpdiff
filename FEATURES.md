...
All videos play in sync with shared transport controls. Scrub, frame-step reliably with repeated `,`/`.` presses, and restart together. Per-source audio switching lets you listen to any asset's audio track independently.
